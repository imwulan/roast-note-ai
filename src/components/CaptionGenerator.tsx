    ...
    <div className="grid gap-6 sm:gap-8 lg:grid-cols-[minmax(0,1fr)_minmax(0,1.1fr)] lg:gap-10">
      ...
      >
        <div className="mb-6 sm:mb-7">
          ...
          <h3 className="mt-2 font-serif text-[24px] leading-tight text-foreground sm:mt-3 sm:text-[32px]">
        ...
        <button
          type="submit"
          disabled={loading}
          className="group press mt-7 inline-flex h-12 w-full items-center justify-center gap-2 overflow-hidden rounded-full bg-primary px-7 text-[13px] font-medium tracking-wide text-primary-foreground shadow-[var(--shadow-soft)] transition-all hover:bg-espresso hover:shadow-[var(--shadow-lift)] disabled:opacity-80 sm:mt-8"
        >
      ...
      <div className="flex flex-col gap-4">
        ...
        {loading && (
          <div className="flex h-full min-h-[320px] items-center justify-center rounded-[20px] border border-border/70 bg-cream/40 grain fade-in sm:min-h-[440px] sm:rounded-[24px]">
